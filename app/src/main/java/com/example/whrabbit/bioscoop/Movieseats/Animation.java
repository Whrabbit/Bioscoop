...
public abstract class Animation<T> extends AnimatorListenerAdapter implements TypeEvaluator<T>, ValueAnimator.AnimatorUpdateListener {
    ...
    public Animation(Interpolator interpolator, int durationMillis) {
